...
// *****************************************Images upload code end here********************************************************** 
		 ...
		 $query7="insert into admin(email,password)values('$email','$password')";
 		$run7=mysqli_query($con, $query7);
 		if ($run2) {
 			echo "Your Data has been submitted into Apptitude Portal";
 		}
 		else {
 			echo "Your Data has not been submitted into Apptitude Portal";
 		}
 	}
?>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5"> Camloc Teacher Portal</h4>
						<button type="button" class="btn btn-primary ml-5" data-toggle="modal" data-target=".bd-example-modal-lg">New Teacher</button>
					</div>
				</div>
				<div class="row w-100">
