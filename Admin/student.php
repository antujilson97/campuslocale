...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query2="insert into login(user_id,Password,Role,email)values('$roll_no','$password','$role','$email')";
		 ...
		 $query5="insert into user(name,password,email,mob)values('$first_name','$password','$email','$mobile_no')";
 		$run5=mysqli_query($con, $query5);
 		if ($run2) {
 			echo "<br>Your Data has been submitted into Exam Portal";
 		}
 		else {
 			echo "<br>Your Data has not been submitted into Exam Portal";
 		}
 	}
?>
