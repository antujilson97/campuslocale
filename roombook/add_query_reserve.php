<?php
	...
	if(ISSET($_POST['add_guest'])){
		...
		$checkin = $_POST['date'];
		$conn->query("INSERT INTO `guest` (firstname, middlename, lastname) VALUES('$firstname', '$middlename', '$lastname')") or die(mysqli_error());
		$query = $conn->query("SELECT * FROM `guest` WHERE `firstname` = '$firstname' && `lastname` = '$lastname'") or die(mysqli_error());
