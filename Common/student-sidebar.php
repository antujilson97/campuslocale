		...
		<nav id="sidebarMenu" class="">
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				<div class="sidebar-header">
					<div class="nav-item">
						<a class="nav-link text-dark" href="../student/student-index.php">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						<a class="nav-link" href="../exam/index.php">
						<span data-feather="bar-chart-2"></span>
						<i class="fa fa-th-list mr-2" aria-hidden="true"></i>Online Exam Portal
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../Student/student_notes.php">
						<span data-feather="bar-chart-2"></span>
						<i class="fa fa-sticky-note-o" aria-hidden="true"></i> Notes 
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="../Student/videoshow.php">
						<span data-feather="bar-chart-2"></span>
						<i class="fa fa-video-camera" aria-hidden="true"></i> Video Lectures
						</a>
					</li>
					<li class="nav-item">
