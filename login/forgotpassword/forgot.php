...
require "mail.php";
	...
	if(!$con = mysqli_connect("localhost","root","","campuslocale")){
	...
	function save_password($password){
		...
		mysqli_query($con,$query);
		$query11 = "update user set password = '$password' where email = '$email' limit 1";
	...
	function valid_email($email){
		...
		$query = "select email from student_info where email = '$email' limit 1";		
