	...
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
			<div class="sub-main">
				...
				<h5 class="">Current Date:<?php $cdate=date("d-m-y");
				echo $cdate;?></h5>
				<div class="row">
					<div class="col-md-12">
			...
			<a href="../Teacher/Print/Attendance/index.php" class="btn btn-primary">Print Attendance</a>
			
			<form action="pdf/print-details.php" method="post" >
			<div class="row">
					<div class="col-md-12 ml-1">
						<section class="mt-3">
							<table class="w-100 table-elements table-three-tr" cellpadding="3">
								...
								<?php
									$sr=1;
									$query="select student_id,subject_code,attendance,attendance_date,attendance_id from student_attendance ORDER BY attendance_date ASC;";
									$run=mysqli_query($con,$query);
									while($row=mysqli_fetch_array($run)) {
									echo	"<tr>";
									echo	"<td>".$sr++."</td>";
									...
									echo	"<td width='20'><a class='btn btn-danger' href=delete-function.php?attendance_id=".$row['attendance_id'].">Delete</a></td>";
									echo	"</tr>";
									} 
								?>
